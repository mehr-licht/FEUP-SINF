...
const Sidebar = (props) => {
    ...
    const styles = { backgroundColor: '#0B0C10', width: props.width, align: 'left', position: 'absolute', right: props.right,zIndex:1 };

    const stylesNav = { backgroundColor: '#1F2833' };

    const navText = { height: '3rem', color: '#c5c6c7', textAlign: 'left' };


    return (
        <body style={styles}>
            <NavLink href="#" color="link" onClick={toggle} style={{ fontSize: '1.5rem', marginBottom: '0rem', color: '#45A29E', textAlign: 'left' }}>
